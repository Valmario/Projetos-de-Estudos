...
function renderBoard() {
  var divBoard = document.querySelector('#sena-board');
  divBoard.innerHTML = '';
...
function renderButtons() {
  var divButtons = document.querySelector('#sena-buttons');
...
function renderSavedGames() {
  var divSavedGames = document.querySelector('#sena-saved-games');
